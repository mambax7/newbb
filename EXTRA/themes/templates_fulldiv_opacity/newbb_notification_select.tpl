    ...
    <form name="notification_select" action="<{$xoops_url}>/modules/<{$xoops_dirname}>/<{$xoops_notification.target_page}>" method="post">
        ...
        <div class="outer forum_table">
            <div class="forum_row">
                ...
                <div class="head"><label for="allbox"></label><input name="allbox" id="allbox" onclick="xoopsCheckAll('notification_select','allbox');" type="checkbox" value="<{$lang_checkall}>" ></div>
                ...
                <{foreach name=inner item=event from=$category.events}>
                    <div class="forum_row">
                        ...
                        <div class="odd">
                            ...
                            <label for="not_list[]"></label><input type="checkbox" id="not_list[]" name="not_list[<{$index}>][status]" value="1" <{if $event.subscribed}>checked<{/if}> >
                        </div>
