...
$icons = [
    'edit'    => "<img src='" . $pathIcon16 . "/edit.png'  alt=" . _EDIT . "' style='text-align:middle;'>",
    'delete'  => "<img src='" . $pathIcon16 . "/delete.png' alt='" . _DELETE . "' style='text-align:middle;'>",
    'clone'   => "<img src='" . $pathIcon16 . "/editcopy.png' alt='" . _CLONE . "' style='text-align:middle;'>",
    'preview' => "<img src='" . $pathIcon16 . "/view.png' alt='" . _PREVIEW . "' style='text-align:middle;'>",
    'print'   => "<img src='" . $pathIcon16 . "/printer.png' alt='" . _CLONE . "' style='text-align:middle;'>",
    'pdf'     => "<img src='" . $pathIcon16 . "/pdf.png' alt='" . _CLONE . "' style='text-align:middle;'>",
    'add'     => "<img src='" . $pathIcon16 . "/add.png' alt='" . _ADD . "' style='text-align:middle;'>",
    '0'       => "<img src='" . $pathIcon16 . "/0.png' alt='" . 0 . "' style='text-align:middle;'>",
    '1'       => "<img src='" . $pathIcon16 . "/1.png' alt='" . 1 . "' style='text-align:middle;'>",
];
