...
define('_MD_NEWBB_CANNOT_POST', '<img title="You cannot start a new topic." src="/modules/newbb/assets/images/icons/application_delete.png"> ');
define('_MD_NEWBB_CAN_VIEW', '<img title="You can view topic." src="/modules/newbb/assets/images/icons/application_form_magnify.png"> ');
define('_MD_NEWBB_CANNOT_VIEW', '<img title="You cannot view topic." src="/modules/newbb/assets/images/icons/application_form_delete.png"> ');
define('_MD_NEWBB_CAN_REPLY', '<img title="You can reply to posts." src="/modules/newbb/assets/images/icons/application_form_edit.png"> ');
define('_MD_NEWBB_CANNOT_REPLY', '<img title="You cannot reply to posts." src="/modules/newbb/assets/images/icons/application_form_delete.png"> ');
define('_MD_NEWBB_CAN_EDIT', '<img title="You can edit your posts." src="/modules/newbb/assets/images/icons/application_edit.png"> ');
define('_MD_NEWBB_CANNOT_EDIT', '<img title="You cannot edit your posts." src="/modules/newbb/assets/images/icons/application_delete.png"> ');
define('_MD_NEWBB_CAN_DELETE', '<img title="You can delete your posts." src="/modules/newbb/assets/images/icons/application_lightning.png"> ');
define('_MD_NEWBB_CANNOT_DELETE', '<img title="You cannot delete your posts." src="/modules/newbb/assets/images/icons/application_delete.png"> ');
define('_MD_NEWBB_CAN_ADDPOLL', '<img title="You can add new polls." src="/modules/newbb/assets/images/icons/chart_bar_add.png"> ');
define('_MD_NEWBB_CANNOT_ADDPOLL', '<img title="You cannot add new polls." src="/modules/newbb/assets/images/icons/chart_bar_delete.png"> ');
define('_MD_NEWBB_CAN_VOTE', '<img title="You can vote in polls." src="/modules/newbb/assets/images/icons/chart_bar.png"> ');
define('_MD_NEWBB_CANNOT_VOTE', '<img title="You cannot vote in polls." src="/modules/newbb/assets/images/icons/chart_bar_delete.png"> ');
define('_MD_NEWBB_CAN_ATTACH', '<img title="You can attach files to posts." src="/modules/newbb/assets/images/icons/folder_go.png"> ');
define('_MD_NEWBB_CANNOT_ATTACH', '<img title="You cannot attach files to posts." src="/modules/newbb/assets/images/icons/folder_delete.png"> ');
define('_MD_NEWBB_CAN_NOAPPROVE', '<img title="You can post without approval." src="/modules/newbb/assets/images/icons/user_go.png"> ');
define('_MD_NEWBB_CANNOT_NOAPPROVE', '<img title="You cannot post without approval." src="/modules/newbb/assets/images/icons/user_delete.png"> ');
define('_MD_NEWBB_CAN_TYPE', '<img title="You can use topic type." src="/modules/newbb/assets/images/icons/tag_blue_add.png"> ');
define('_MD_NEWBB_CANNOT_TYPE', '<img title="You cannot use topic type." src="/modules/newbb/assets/images/icons/tag_blue_delete.png"> ');
define('_MD_NEWBB_CAN_HTML', '<img title="You can use HTML syntax." src="/modules/newbb/assets/images/icons/html_add.png"> ');
define('_MD_NEWBB_CANNOT_HTML', '<img title="You cannot use HTML syntax." src="/modules/newbb/assets/images/icons/html_delete.png"> ');
define('_MD_NEWBB_CAN_UPLOAD', '<img title="You can upload." src="/modules/newbb/assets/images/icons/drive_add.png"> ');
